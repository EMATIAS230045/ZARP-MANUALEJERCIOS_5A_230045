...
export class JsonComponent implements OnInit {
  dtOptions: any = {}; // Opciones de configuración de DataTable
  ...
  jsonData: string = JSON.stringify(this.datos, null, 2); // JSON de los datos, con formato legible
  ...
  toggleJsonView() {
    // Alterna entre mostrar datos en formato tabla y en formato JSON
    this.jsonData = JSON.stringify(this.datos, null, 2); // Convierte los datos a JSON con formato
  }
}
